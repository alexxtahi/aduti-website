...
<body>
    ...
    <section class="page-header-section set-bg" data-setbg="{{ asset('arcade-master/img/header-bg.jpg') }}">
        <div class="container">
            <h1 class="header-title">A propos de nous <span>.</span></h1>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 intro-text">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p>Pellentesque lorem dolor, malesuada eget tortor vitae, tristique lacinia lectus.
                                ...
                                accumsan, tortor nisl iaculis ligula. </p>
                        </div>
                        <div class="col-md-6">
                            <p>Curabitur finibus dolor vel lectus pretium interdum a eget ante. Morbi rhoncus feugiat
                                imperdiet. Curabitur non maximus leo. Nulla in ipsum sed magna egestas bibendum. Integer
                                in sem sagittis, commodo mi sit amet, commodo nibh. Suspendisse potenti. Aliquam erat
                                volutpat. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 pt-4">
                    <img src="{{ asset('arcade-master/img/about.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="testimonials-slider" id="test-slider">
                        <div class="ts-item">
                            <p>Pellentesque lorem dolor, malesuada eget tortor vitae, tristique lacinia lectus.
                                Pellentesque sed accumsan risus, id aliquam nulla. Integer lorem risus, feugiat at
                                mauris malesuada, accumsan pellentesque ipsum. Nunc dapibus, libero ut pulvinar
                                accumsan, tortor nisl iaculis ligula. Curabitur finibus dolor vel lectus pretium
                                interdum a eget ante. </p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="team-member">
                        <img src="{{ asset('arcade-master/img/team/1.jpg') }}" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member">
                        <img src="{{ asset('arcade-master/img/team/2.jpg') }}" alt="">
                        <div class="member-info">
                            <h2>Lili Jameson</h2>
                            <p>Senior Architect</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member">
                        <img src="{{ asset('arcade-master/img/team/3.jpg') }}" alt="">
                        <div class="member-info">
                            <h2>Michael Dow</h2>
                            <p>Senior Architect</p>
                        </div>
